...
public class ClientLaunchViewModel : ViewModelBase
{
    ...
    public bool Start(MainViewModel mvm)
    {
        ...
        var config = new ConfigIni()
        {
            ...
            AudioId = Output == null ? null : Output.AudioOutputs[Output.AudioIndex].DevicePath,
        };
    ...
    public void StartRebind()
    {
        ...
        WindowUtils.MoveWindow(rebindWindowHandle, Output!.DisplayOutputs[Output.DisplayIndex].Rect, true);
    }
    ...
    public void MoveGameWindow()
    {
        if (Output != null)
        {
            WindowUtils.MoveWindow(window_, Output.DisplayOutputs[Output.DisplayIndex].Rect, false);
        }
        else
        {
