...
public class RowInfo : ReactiveObject
{
    public RowInfo()
    {
    }

    public List<DisplayOutput> DisplayOutputs => DisplayOutput.EnumerateDisplays();
    public List<AudioOutput> AudioOutputs => AudioOutput.EnumerateOutputs();
...
{
    private bool ReadMapping(out RowInfo? row, ref Utf8JsonReader reader)
    {
        row = null;
