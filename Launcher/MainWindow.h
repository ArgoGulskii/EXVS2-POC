...
ref class MainWindow : public System::Windows::Forms::Form {
 public:
  MainWindow() : state_(new LauncherState()) { InitializeComponent(); }

 protected:
  ~MainWindow() { delete state_; }
...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->listboxInstances->ItemCheck +=
        gcnew System::Windows::Forms::ItemCheckEventHandler(this, &MainWindow::listboxInstances_ItemCheck);
    this->listboxInstances->SelectedIndexChanged +=
        gcnew System::EventHandler(this, &MainWindow::listboxInstances_SelectedIndexChanged);
    //
    // buttonLaunch
    //
